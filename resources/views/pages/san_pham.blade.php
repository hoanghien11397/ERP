...
@section('content')
  ...
  <main id="sanpham">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-5">
          <img src="https://www.itgvietnam.com/wp-content/uploads/2018/06/tong-the.png">
        </div>
        <div class="col-sm-7">
        <div>
          <p>3S ERP là bộ giải pháp phần mềm quản trị doanh nghiệp ERP được phát triển bài bản, công phu, 
            là kết quả của nhiều năm kinh nghiệm triển khai trên các doanh nghiệp lớn của Việt Nam. Hệ thống
            3S ERP có nhiều chức năng đáp ứng được nhu cầu quản lý của các doanh nghiệp thuộc nhiều ngành nghề
            khác nhau, đặc biệt phù hợp với các doanh nghiệp sản xuất và thương mại phân phối, bán lẻ.&nbsp;
          </p>
        </div>
        <div class="brm">
          <a class="readmore" href="https://itgvietnam.com/san-pham/3s-erp/">Xem thêm</a>
        </div>
        </div>
      </div>
      <br/>
